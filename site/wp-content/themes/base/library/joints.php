...
function joints_scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    wp_register_script( 'joints-modernizr', get_stylesheet_directory_uri() . '/library/js/vendor/modernizr.min.js', array(), '2.6.2', false );
    
    // adding Foundation scripts file in the footer
    wp_register_script( 'foundation-js', get_template_directory_uri() . '/library/js/main.min.js', array( 'jquery' ), '', true );
   
    // register main stylesheet
    wp_register_style( 'joints-stylesheet', get_stylesheet_directory_uri() . '/library/css/app.min.css?' . rand(0,10000000), array(), '', 'all' );

    // register main stylesheet
    wp_register_style( 'joints-ie-only', get_stylesheet_directory_uri() . '/library/css/ie.min.css', array(), '', '' );
    
    // register foundation icons
    wp_register_style( 'foundation-icons', get_stylesheet_directory_uri() . '/library/icons/foundation-icons.css', array(), '', 'all' );

    // register entypo icons
    wp_register_style( 'entypo-icons', get_stylesheet_directory_uri() . '/library/icons/entypo.css', array(), '', 'all' );
